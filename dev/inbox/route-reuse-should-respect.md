...
Planned together with task `centralize-route-ownership-helpers-and` because the concrete route-reuse bug is the first implementation slice of the broader route ownership helper cleanup.
